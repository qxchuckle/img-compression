! function(e, t) {
    ...
    return function(e) {
        ...
        r.prototype.init = function() {
            ...
            if (e.img = i, e.blob = l, e.canvas = u, n ? e.fileName = r ? "base64.jpg" : t.split("/").pop() : e.fileName = t.name, !document.createElement("canvas").getContext) throw new Error("�������֧��canvas");
            return new a(function(n, a) {
                i.onerror = function() {
                    var e = new Error("����ͼƬ�ļ�ʧ��");
                    throw a(e), e
                }, i.onload = function() {
                    e._getBase64().then(function(e) {
                        if (e.length < 10) {
                            var t = new Error("����base64ʧ��");
                            throw a(t), t
                        }
                        return e
                    }).then(function(r) {
